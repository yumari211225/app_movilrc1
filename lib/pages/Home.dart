...
class _HomeState extends State<Home> {
  ...
  void _launchGitHub() async {
    const url = 'https://github.com/yumari211225/app_movilrc1';
...
class _MyTextWidgetState extends State<MyTextWidget> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const Image(
          image: AssetImage('assets/images/yumaimag.jpeg'),
          width: 350,
          height: 350,
        ),
        ...
        Row(
          children: [
            const Expanded(child: Text('211225 Morales Mendoza Yumari Teresa')),
            IconButton(
              icon: const Icon(Icons.phone),
              onPressed: () => _launchCaller('9681282169'),
            ),
            const SizedBox(width: 10),
            IconButton(
              icon: const Icon(Icons.message),
              onPressed: () => _launchSMS('9681282169'),
            ),
          ],
        ),
      ],
